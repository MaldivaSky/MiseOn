    ...
    <div className="grid grid-cols-2 gap-2">
      {FONTES.map((f) => (
        <button
          ...
          className={`rounded-xl border-2 p-3 text-left shadow-sm transition ${value === f.nome ? 'border-gray-900 bg-gray-50' : 'border-transparent bg-white hover:border-gray-200'}`}
        >
