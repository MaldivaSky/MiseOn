...
export default function Home() {
  ...
  return (
    ...
    >
      ...
      {/* ── Pagamentos transparentes (Efí Bank) ── */}
      <section id="pagamentos" style={{ borderTop: '1px solid rgba(10,92,196,0.15)' }} className="py-24">
        <div className="mx-auto max-w-6xl px-6">
          <div style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: 12, letterSpacing: '.3em', color: '#FC5B24', textTransform: 'uppercase', marginBottom: 18 }}>06 — Pagamentos transparentes</div>
          <div className="grid gap-10 lg:grid-cols-[1.1fr_0.9fr] lg:items-start">
            <div>
              <h2 style={{ fontFamily: "'Sora', sans-serif" }} className="text-3xl font-extrabold sm:text-4xl leading-tight">
              ...
              <p style={{ color: '#AEB9CE' }} className="mt-5 max-w-xl text-base leading-relaxed">
                ...
                conta da sua loja. A MiseOn não segura o seu dinheiro e não cobra comissão por venda: você paga só a
                mensalidade fixa.
              </p>
            ...
            {/* Tabela de taxas — transparência total */}
            <div style={{ border: '1px solid rgba(255,255,255,.09)', background: 'rgba(10,92,196,0.05)', borderRadius: 24 }} className="p-6 sm:p-7">
              ...
              <p style={{ color: 'rgba(234,241,251,0.4)' }} className="mt-4 text-[11px] leading-relaxed">
                Taxas cobradas pelo Efí Bank (tabela pública de {EFI_TARIFAS.referencia}, negociável por volume) — a MiseOn
                não fica com nada das suas vendas. Confira em{' '}
                <a href={EFI_LINKS.tarifas} target="_blank" rel="noreferrer" className="underline hover:text-white transition">sejaefi.com.br/tarifas</a>.
              </p>
              <a
