...
export default function Home() {
  return (
    <div className="min-h-screen bg-gray-50 text-gray-900 dark:text-gray-100 selection:bg-orange-500 selection:text-white dark:bg-[#0a0a0a] dark:text-gray-100">
      
      {/* Navbar Minimalista */}
      <nav className="fixed inset-x-0 top-0 z-50 border-b border-gray-200 dark:border-gray-800/50 bg-white dark:bg-gray-900 dark:border-gray-800/80 backdrop-blur-lg dark:border-white/5 dark:bg-[#0a0a0a]/80">
        <div className="mx-auto flex max-w-6xl items-center justify-between px-6 py-4">
          <img src="/logo.png" alt="MiseOn" className="h-8 dark:brightness-0 dark:invert" />
          <div className="flex gap-4">
            <a href="/admin/login" className="flex items-center text-sm font-semibold text-gray-600 dark:text-gray-300 transition hover:text-gray-900 dark:text-gray-400 dark:hover:text-white">
              Login Lojista
            </a>
      ...
      <section className="relative overflow-hidden pt-32 pb-20 lg:pt-48 lg:pb-32">
        ...
        <div className="mx-auto max-w-5xl px-6 text-center relative z-10">
          ...
          <div className="mt-10 flex flex-col items-center justify-center gap-4 sm:flex-row">
            ...
            <a href="/natureba" className="flex w-full items-center justify-center gap-2 rounded-full border-2 border-orange-500 bg-white dark:bg-gray-900 dark:border-gray-800 px-8 py-4 text-lg font-bold text-orange-600 transition hover:bg-orange-50 dark:border-orange-500/50 dark:bg-gray-900 dark:text-orange-400 dark:hover:bg-gray-800 sm:w-auto">
              Visitar loja de exemplo
            </a>
            <a href={zap('Olá! Quero ver o MiseOn funcionando')} className="flex w-full items-center justify-center gap-2 rounded-full border-2 border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900 dark:border-gray-800 px-8 py-4 text-lg font-bold text-gray-800 transition hover:bg-gray-50 dark:border-gray-800 dark:bg-gray-900 dark:text-white dark:hover:bg-gray-800 sm:w-auto">
              Falar com Consultor
            </a>
          </div>
          <p className="mt-4 text-sm font-medium text-gray-500 dark:text-gray-400">Sem cartão de crédito · Cancele quando quiser</p>
        </div>
      </section>

      {/* Grid de Recursos (Features) */}
      <section className="border-t border-gray-100 dark:border-gray-800 bg-white dark:bg-gray-900 dark:border-gray-800 py-24 dark:border-white/5 dark:bg-[#0a0a0a]">
        <div className="mx-auto max-w-6xl px-6">
          ...
          <div className="grid gap-8 md:grid-cols-2">
            {RECURSOS.map((r, i) => (
              <div key={i} className="group relative overflow-hidden rounded-3xl border border-gray-200 dark:border-gray-800 bg-gray-50 p-8 transition hover:border-blue-500/50 dark:border-gray-800 dark:bg-gray-900/50">
                <div className="mb-6 flex h-14 w-14 items-center justify-center rounded-2xl bg-white dark:bg-gray-900 dark:border-gray-800 shadow-sm dark:bg-gray-800 text-blue-600 dark:text-blue-400 group-hover:scale-110 transition-transform">
                  {r.icon}
                </div>
      ...
      <section className="py-24">
        <div className="mx-auto max-w-4xl px-6 text-center">
          ...
          <div className="mx-auto mt-14 max-w-lg overflow-hidden rounded-3xl border border-orange-500/30 bg-white dark:bg-gray-900 dark:border-gray-800 shadow-2xl dark:border-orange-500/20 dark:bg-gray-900 relative">
            ...
            <div className="p-8 sm:p-10">
              ...
              <p className="mt-4 text-sm font-medium text-gray-500 dark:text-gray-400">Valor fixo. Sem pegadinhas, sem taxas extras.</p>
      ...
      {/* Footer */}
      <footer className="border-t border-gray-200 dark:border-gray-800 py-12 text-center dark:border-white/5 bg-white dark:bg-[#0a0a0a]">
        ...
        <p className="text-sm text-gray-500 dark:text-gray-400">Contato: rafaelmaldivas@gmail.com</p>
        <p className="mt-2 text-sm text-gray-500 dark:text-gray-400">Desenvolvido por Mald1vas.T4ch © 2026</p>
      </footer>
    </div>
  );
}
