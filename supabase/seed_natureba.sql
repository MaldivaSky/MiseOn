...
INSERT INTO produtos (loja_id, categoria_id, nome, descricao, preco, is_combo, destaque)
SELECT (SELECT id FROM l), c.id, p.nome, p.descricao, p.preco, p.combo, p.destaque
FROM (VALUES
  ('BAGUETES 30CM','BAGUETE DE FRANGO - 30CM','Baguete artesanal de fermentação natural. Patê de frango caseiro, queijo prato, alface e tomate.',27.00,false,true),
  ('BAGUETES 30CM','BAGUETE DE PRESUNTO E QUEIJO - 30CM','Maionese, queijo prato, presunto, alface e tomate.',18.00,false,true),
  ('BAGUETES 15CM','BAGUETE DE FRANGO - 15CM','Patê de frango caseiro, queijo prato, alface e tomate.',24.00,false,false),
  ('BAGUETES 15CM','BAGUETE DE CARNE LOUCA - 15CM','Carne desfiada com tempero caseiro, alface e tomate.',28.00,false,false),
  ('FRESCOR NA ÁREA - SALADA!','SALADA FRANGO CREMOSO','Alface, tomate cereja, cenoura, palmito, pepino, croutons e patê de frango. Pote 750ml (~500g).',29.98,false,true),
  ('NOVIDADE NA ÁREA - DOCES','BOLO BOMBOM NINHO COM NUTELLA','Sobremesa ultra cremosa em camadas.',13.99,false,false),
  ('COMBOS DE 30CM','COMBO BAGUETE DE FRANGO - 30CM','Baguete de frango 30cm + bebida à sua escolha.',37.00,true,false),
  ('BEBIDAS','COCA COLA 600ML','Sua bebida chega geladinha, quase trincando!',10.00,false,false),
  ('BEBIDAS','ÁGUA MINERAL NATURAL 510ML','Sua bebida chega geladinha!',3.50,false,false)
) AS p(cat, nome, descricao, preco, combo, destaque)
